...
<?php  rewind_posts(); ?>
  ...
  <?php if ( have_posts() ) : while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
    ...
    <div class="item <?php if( $the_query->current_post == 0) : ?>active<?php endif; ?>">
      ...
      <?php 
        ...
        $thumbnail_meta = get_post_meta( $thumnbnail_id. '_wp_attachment_image_alt', true);
      ?>  
  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <footer class="text-center static-footer">
          의정부시 신곡1동 722-1번지 장암현대3차 동신A 상가2층 English Trip</br>
      T.031)873-2014 &bull; info@englishtrip.net</br>
